...
export default function DashboardPage() {
  ...
  ] = useState<UpcomingMaintenanceRecord[]>([]);
  ...
  const quickActions = canManage
    ? [
        ...
        },
        {
          ...
          description:
            "Search and manage the full equipment list.",
          icon: "📦",
        },
        {
          href: "/maintenance",
          title: "Maintenance",
          description:
            "Review repairs and upcoming service.",
          icon: "🔧",
        },
        {
          href: "/transfers",
          title: "Transfers",
          description:
            "Track equipment moved to another space or team.",
          icon: "🚚",
        },
        {
          href: "/tools/export",
    ...
    : [
        {
          ...
          title: "View Equipment",
          description:
            "Search and view the full equipment list.",
          icon: "📦",
        },
        {
          href: "/reports",
          title:
            "Capital Forecast",
          description:
            "Review upcoming equipment replacement needs.",
          icon: "📊",
        },
        {
          href: "/tools/export",
          title: "Export Center",
          description:
            "Download inventory data as CSV files.",
          icon: "📤",
        },
      ];
      ...
      {!canManage && (
        <section className="rounded-2xl border border-blue-200 bg-blue-50 px-5 py-4 text-blue-900 shadow-sm">
          ...
          <p className="mt-1 text-sm leading-6 text-blue-700">
            ...
            You can browse equipment,
            review the capital forecast,
      ...
      <SectionCard
        ...
        description={
          canManage
            ...
            : "Open the tools available to Volunteer accounts."
        }
